...
private struct VarianceHistogramThresholdOverlay: View {
    ...
    var body: some View {
        Canvas { context, canvasSize in
            ...
            context.fill(shaded, with: .color(Color.phantomAdvancedSoft.opacity(0.10)))
            ...
            context.stroke(
                cutLine,
                with: .color(Color.phantomAdvancedSoft.opacity(0.68)),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            HStack(alignment: .firstTextBaseline) {
                ...
                .foregroundStyle(Color.phantomAdvancedSoft.opacity(0.90))
