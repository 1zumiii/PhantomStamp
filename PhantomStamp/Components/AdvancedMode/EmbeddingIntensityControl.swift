        ...
        Canvas { context, canvasSize in
            ...
            for (index, count) in summary.binCounts.enumerated() {
                ...
                context.fill(
                    ...
                    with: .color(Color.phantomAdvancedStrength.opacity(0.24))
                )
            }
        }
...
private struct AmplitudeHistogramIntensityOverlay: View {
    ...
    var body: some View {
        Canvas { context, canvasSize in
            ...
            context.fill(shaded, with: .color(Color.phantomAdvancedStrength.opacity(0.10)))
            ...
            context.stroke(
                cutLine,
                with: .color(Color.phantomAdvancedStrength.opacity(0.68)),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            HStack(alignment: .firstTextBaseline) {
                ...
                .foregroundStyle(Color.phantomAdvancedStrength.opacity(0.90))
